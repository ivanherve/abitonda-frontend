        ...
        <Modal show={props.show} onHide={props.hide} centered size='xl'>
            ...
            <Modal.Body>
                <Form>
                    ...
                    <Form.Group as={Row} controlId="formSurnameAdd">
                        <Form.Label column sm="2">
                            Nom de famille
                        </Form.Label>
                        <Col sm="10">
                            <Form.Control type="text" onChange={e => setsurname(e.target.value)} />
                        </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Row} controlId="formProfilAdd">
                        ...
                        <Col sm="10">
                            <Form.Control as="select" onChange={e => setTheProfil(e.target.value)}>
                                {
                                    profiles.map(p =>
                                        (p.Profil_Id > 1 && p.Profil_Id < 4)
                                            ?
                    ...
                    <Form.Group as={Row} controlId="formPlaintextConfPasswordAdd">
                        ...
                        <Col sm="10">
                            <Form.Control type="password" onChange={e => setconfPassword(e.target.value === password)} />
                        </Col>
                    </Form.Group>
                </Form>
            </Modal.Body>
            ...
            <div>
                <Form>
                    <Form.Group as={Row} controlId="formFirstname">
                        ...
                        <Col sm="10">
                            <Form.Control placeholder={oneTeacher.Firstname} onChange={props.setfirstname} />
                        </Col>
                    </Form.Group>
                    ...
                    </Form.Group>
                    {
                        ...
                        <Form.Group as={Row} controlId="formProfilEdit">
                            ...
                            <Col sm="10">
                                <Form.Control as="select" onChange={props.setprofilEdit} disabled={oneTeacher.Profil_Id > 3}>
                                    {
                                        profiles.map(p =>
                                            (p.Profil_Id !== 1)
                                            &&
                    ...
                    <Form.Group as={Row} controlId="formClassEdit">
                        ...
                        <Col sm="10">
                            <OverlayTrigger
                                ...
                                overlay={<Tooltip>Veuillez modifier la classe dans l'onglet "Classes"</Tooltip>}
                            >
                                <Form.Control type="text" disabled defaultValue={oneTeacher.Class} />
                            </OverlayTrigger>
                        </Col>
                    </Form.Group>
...
function EditPassword(props) {
    return (
        <div>
            <Form>
                {
                    (props.teacher.User_Id === JSON.parse(sessionStorage.getItem('userData')).user.User_Id)
                    &&
                    <Form.Group as={Row} controlId="formPlaintextOldPassword">
                        ...
                        <Col sm="9">
                            <Form.Control type="password" placeholder="password" onChange={props.setoldpwd} ></Form.Control>
                        </Col>
                    </Form.Group>
                }
                <hr />
                <Form.Group as={Row} controlId="formPlaintextNewPassword">
                    ...
                    <Col sm="9">
                        <Form.Control type="password" placeholder="password" onChange={props.setnewpwd} disabled={!((props.teacher.User_Id !== JSON.parse(sessionStorage.getItem('userData')).user.User_Id) || !props.isPwdNotCorrect)}></Form.Control>
                    </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} controlId="formPlaintextConfPassword">
                    ...
                    <Col sm="9">
                        <Form.Control type="password" placeholder="password" onChange={props.setconfpassword} disabled={!((props.teacher.User_Id !== JSON.parse(sessionStorage.getItem('userData')).user.User_Id) || !props.isPwdNotCorrect)}></Form.Control>
                    </Col>
                </Form.Group>
            </Form>
            <hr />
            {
                ((props.teacher.User_Id !== JSON.parse(sessionStorage.getItem('userData')).user.User_Id) || !props.isPwdNotCorrect)
                    ?
